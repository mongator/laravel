...
/**
 * Base class of repository of Model\Article519170d6aebcc document.
 */
abstract class Article519170d6aebccRepository extends \Mongator\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\Article519170d6aebcc';
        $this->isFile = false;
        $this->collectionName = 'model_article519170d6aebcc';
