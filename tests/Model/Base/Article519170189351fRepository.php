...
/**
 * Base class of repository of Model\Article519170189351f document.
 */
abstract class Article519170189351fRepository extends \Mongator\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\Article519170189351f';
        $this->isFile = false;
        $this->collectionName = 'model_article519170189351f';
