...
/**
 * Base class of repository of Model\Article5191756e9e8d8 document.
 */
abstract class Article5191756e9e8d8Repository extends \Mongator\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\Article5191756e9e8d8';
        $this->isFile = false;
        $this->collectionName = 'model_article5191756e9e8d8';
