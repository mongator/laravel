...
/**
 * Base class of repository of Model\Article51916fe6e88a8 document.
 */
abstract class Article51916fe6e88a8Repository extends \Mongator\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\Article51916fe6e88a8';
        $this->isFile = false;
        $this->collectionName = 'model_article51916fe6e88a8';
